    ...
    <nav className="bg-secondary">
      ...
      {isOpen && isMobile && (
        <div className="lg:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <NavLink href="/ingestion" mobile>
              Ingestion
            </NavLink>
            <NavLink href="/filter" mobile>
              Filter
            </NavLink>
            <NavLink href="/dashboard/filters" mobile>
              Filter Dashboard
            </NavLink>
            <NavLink href="/dashboard/cases" mobile>
              Case Management
            </NavLink>
            <NavLink href="/dashboard/saas" mobile>
              SaaS Dashboard
            </NavLink>
          </div>
        </div>
      ...
      {!isMobile && isOpen && (
        <div className="hidden md:block lg:hidden">
          <div className="px-2 pt-2 pb-3 flex flex-wrap justify-center">
            <NavLink href="/">Home</NavLink>
            <NavLink href="/ingestion">Ingestion</NavLink>
            <NavLink href="/filter">Filter</NavLink>
            <NavLink href="/dashboard/filters">Filter Dashboard</NavLink>
...
function NavLink({ href, children, mobile = false }: NavLinkProps) {
  const baseClasses = "text-foreground hover:text-primary hover:bg-secondary transition-colors duration-200"
